...
func task7ClassRunSidecar(t *testing.T, root string, compileFiles []string) task7ClassSidecarResponse {
	...
	request := map[string]any{"protocol": 2, "operation": "transform", "tsConfigPath": filepath.Join(root, "tsconfig.json"), "projectDir": root, "compileFileNames": compileFiles, "fileNames": compileFiles, "changedFiles": []struct{}{}}
