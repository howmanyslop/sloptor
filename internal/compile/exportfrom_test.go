...
func TestCompileProjectExportFromModel(t *testing.T) {
	...
	wants := map[string]string{
		...
		"out/_scratch_retypeonly.luau": "-- Compiled with sloptor v2.5.0\n" +
			"local n = 5\n" +
			"print(n)\n" +
			"return nil\n",
		...
		"out/_scratch_eqtable.luau": "-- Compiled with sloptor v2.5.0\n" +
			"return {\n" +
			"\ta = 1,\n" +
			"\tb = \"two\",\n" +
			"}\n",
		// `export =` a function as the final statement: direct `return f`.
		"out/_scratch_eqfunc.luau": "-- Compiled with sloptor v2.5.0\n" +
			"local function f()\n" +
			"\treturn 1\n" +
			"end\n" +
			"return f\n",
		...
		"out/_scratch_eqmid.luau": "-- Compiled with sloptor v2.5.0\n" +
			"local t = {\n" +
			"\ta = 1,\n" +
			"}\n" +
			"local exports = t\n" +
