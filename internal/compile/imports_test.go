...
const importsHeaderModel = "-- Compiled with sloptor v2.3.3\n" +
...
func TestCompileProjectImportsModel(t *testing.T) {
	...
	wants := map[string]string{
		...
		"out/_scratch_typeonly.luau": "-- Compiled with sloptor v2.3.3\n" +
			"local n = 1\n" +
			"print(n)\n" +
			"return nil\n",
		...
		// runtime lib) vanish.
		"out/_scratch_elide.luau": "-- Compiled with sloptor v2.3.3\n" +
			"local s = \"types\"\n" +
			"print(s)\n" +
			"return nil\n",
		...
		"out/_scratch_eqns.luau": "-- Compiled with sloptor v2.3.3\n" +
			"local A = Ambient\n" +
			"print(A.val)\n" +
			"return nil\n",
		...
		"out/_scratch_sub/inner.luau": "-- Compiled with sloptor v2.3.3\n" +
		...
		"out/_scratch_types.luau": "-- Compiled with sloptor v2.3.3\n" +
			"local tag = \"types\"\n" +
			"return {\n" +
			"\ttag = tag,\n" +
			"}\n",
